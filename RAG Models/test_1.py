from transformers import XLNetTokenizer, XLNetForSequenceClassification, XLNetForConditionalGeneration
from sentence_transformers import SentenceTransformer, util

# Load XLNet model and tokenizer for retrieval
retriever_model = SentenceTransformer('xlnet-base-cased')

# Load XLNet model and tokenizer for generation
generation_model = XLNetForConditionalGeneration.from_pretrained("xlnet-base-cased")
generation_tokenizer = XLNetTokenizer.from_pretrained("xlnet-base-cased")
...
input_ids = generation_tokenizer.encode(input_text, return_tensors="pt", max_length=512, truncation=True)

# Generate output response
output = generation_model.generate(input_ids=input_ids, max_length=100, num_return_sequences=1, early_stopping=True)

# Decode and print generated response
generated_response = generation_tokenizer.decode(output[0], skip_special_tokens=True)
