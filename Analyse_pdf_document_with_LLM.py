...
class Document:
    ...
    def __convertToText(self, fileName):
        ...
        converter = TextConverter(self.resource_manager, self.fake_file_handle, laparams=laparams)
    ...
    def __textAnalysis(self, text):
        ...
        'work', 'activity', 'activities', 'https', 'org', 'datum', 'human', 'ethics', 'ethical', '2016', '2014', '37', '<', '>', 'eos'
        ]
